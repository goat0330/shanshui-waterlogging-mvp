...
// These URLs are the direct official images already approved for the RC2.3 MVP
// same-event bindings. Page-only or exact-scene-unverified cases stay text-only.
